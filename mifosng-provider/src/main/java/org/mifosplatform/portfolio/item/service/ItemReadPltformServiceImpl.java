...
import org.mifosplatform.portfolio.item.data.ItemTypeData;
import org.mifosplatform.portfolio.item.data.UniteTypeData;
import org.mifosplatform.portfolio.item.domain.ItemEnumType;
import org.mifosplatform.portfolio.item.domain.UnitEnumType;
...
@Service
public class ItemReadPltformServiceImpl implements ItemReadPltformService{
	private final JdbcTemplate jdbcTemplate;
	private final PlatformSecurityContext context;

	@Autowired
	public ItemReadPltformServiceImpl(final PlatformSecurityContext context,
	...
	public List<ChargesData> retrieveChargeCode() {
		 String sql = "select s.id as id,s.charge_code as charge_code,s.charge_description as charge_description from charge_codes s  where s.charge_code='OTC'";
...
private static final class SalesDataMapper implements
	...
	public String schema() {
		return "i.id AS id,i.item_code as itemCode,i.item_description AS itemDescription,i.item_class as itemClass,i.units AS units, "
			+" i.charge_code as chargeCode,i.unit_price as unitPrice,i.warranty as warranty FROM item_master i ";
